...
import { AnimationArrayType, SortingAlgorithmType } from "@/lib/algoritm/types";
import { generateRandomNumberFromInterval, MAX_ANIMATION_SPEED } from "@/lib/algoritm/utils";
import React, {
  ReactNode,
  createContext,
  useContext,
