...
import { Slider } from "@/_components/input/slider";
import { useSortingAlgorithmContext } from "@/_context/visualizer";
import { SortingAlgorithmType } from "@/lib/algoritm/types";
import { algorithmOptions, generateAnimationArray, sortingAlgorithmsData } from "@/lib/algoritm/utils";
...
export default function Home() {
  ...
  return (
    <main className="absolute text-black bg-black top-0 h-screen w-screen z-[-2]">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                {requiresReset ? (
                  ...
                  <FaPlayCircle color="white" className="text-system-green60 h-8 w-8" />
                )}
              </button>
            </div>
          ...
          <div className="relative h-[calc(100vh-66px)] w-full">
            <div className="absolute bottom-[32px] w-full mx-auto left-0 right-0 flex justify-center items-end">
              {arrayToSort.map((value, index) => (
                <div
                  key={index}
                  className="array-line relative w-1 mx-0.5 shadow-lg opacity-70 rounded-lg bg-white"
